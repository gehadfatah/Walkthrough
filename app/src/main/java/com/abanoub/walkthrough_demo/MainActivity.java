...
public class MainActivity extends WalkthroughActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        WalkthroughItem page1 = new WalkthroughItem(R.drawable.tutorial1, getString(R.string.walkthrough_1_title), getString(R.string.walkthrough_1_details));
        ...
        WalkthroughItem page2 = new WalkthroughItem(R.drawable.tutorial2, getString(R.string.walkthrough_2_title), getString(R.string.walkthrough_2_details));
        ...
        WalkthroughItem page3 = new WalkthroughItem(R.drawable.tutorial3, getString(R.string.walkthrough_3_title), getString(R.string.walkthrough_3_details));
